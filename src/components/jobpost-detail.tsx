...
export default function JobPostDetail({ jobPost }: JobPostDetailProps) {
  return (
    <div className='p-4 h-[calc(100dvh-4rem-1px)]  max-w-lg mx-auto flex flex-col gap-4'>
      <div id='1' className='flex-shrink-0'>
        <JobPostHeader />
      </div>

      <div id='2' className='flex-1 overflow-y-auto space-y-2'>
      ...
      <div className='flex-shrink-0'>
        <Button asChild className='text-2xl w-full mb-2' size={'lg'}>
          <Link href={true ? `/jobpost/` : '/register'}>Invia candidatura</Link>
        </Button>
        <JobPostFooter />
      </div>
    </div>
